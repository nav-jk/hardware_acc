...
HLS_SOURCES = ../../../../winograd_test.cpp ../../../../winograd.cpp
...
$(ObjDir)/winograd_test.o: ../../../../winograd_test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../winograd_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/winograd_test.d

$(ObjDir)/winograd.o: ../../../../winograd.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../winograd.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/winograd.d
