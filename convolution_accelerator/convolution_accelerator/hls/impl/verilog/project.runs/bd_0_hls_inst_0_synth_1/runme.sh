...
HD_PWD='/home/nirmal-thomas/Documents/dev/hls_dev/hardware_acc/convolution_accelerator/convolution_accelerator/hls/impl/verilog/project.runs/bd_0_hls_inst_0_synth_1'
cd "$HD_PWD"
