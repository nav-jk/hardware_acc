...
void winograd(float *in_g, float *in_d, float *out_y) {
...
#pragma HLS UNROLL
    U[i][0] = Gg[i][0];
    U[i][1] = fixed32_16(0.5) * (Gg[i][0] + Gg[i][1] + Gg[i][2]);
    U[i][2] = fixed32_16(0.5) * (Gg[i][0] - Gg[i][1] + Gg[i][2]);
    U[i][3] = Gg[i][2];
  }
